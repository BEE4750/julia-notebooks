...
# ╔═╡ 1c084b55-11c1-49d3-910e-054681214a77
# use this block and the one after it to plot a diagram of the system. We have started you off with a basic structure.
begin
...
# ╔═╡ e16b228c-eeeb-11eb-2134-d1e98ce2d68d
# edit the code below to set your name and Cornell ID (i.e. email without @cornell.edu)

student = (name = "Jazzy Doe", cornell_id = "jazz")

# ╔═╡ c18e51ec-daad-480a-b87f-9e627991afc4
md"""
# Assignment 1
"""

# ╔═╡ 57a688e1-cfc3-481a-975f-3b4960d83383
md"""
Cheap Plastic Products, Inc. is operating a plant that produces 100 ``\text{m}^3``/day of wastewater that is discharged into Pristine Brook. The wastewater contains 1 ``\text{kg/m}^3`` of YUK, a toxic substance. The US Environmental Protection Agency has imposed an effluent standard on the plant prohibiting discharge of more than 20 ``\text{kg}``/day of YUK into Pristine Brook.

Cheap Plastic Products has analyzed two methods for reducing its discharges of YUK. Method 1 is land disposal, which costs ``\$X_1^2/20`` per day, where ``X_1`` is the amount of wastewater disposed of on the land (``\text{m}^3``/day). With this method, 20% of the YUK applied to the land will eventually drain into the stream (*i.e.*, 80% of the YUK is removed by the soil). 

Method 2 is a chemical treatment system which costs \$1.50 per ``\text{m}^3`` of wastewater treated. The chemical treatment has an efficiency of ``e= 1 - 0.005X_2``, where ``X_2`` is the quantity of wastewater (``\text{m}^3``/day) treated. For example, if ``X_2 = 50 \text{m}^3``/day, then ``e = 1 - 0.005(50) = 0.75``, so that 75% of the YUK is removed.

**Your assignment is to determine an optimal treatment program for the factory using a combination of these methods and direct discharge into Pristine Brook.**
"""

# ╔═╡ b9cbf10e-5038-487f-8705-8edaed9533fd
md"""
## Part 1: Problem Description

Draw a diagram of the system, or use the one provided in the assignment, to show an overview of the system you are modeling. Include a caption and any nomenclature necessary for understanding your summary or diagram. 
"""

# ╔═╡ 29250264-1fff-42e0-b320-334086d85b25
graphplot(A, names=names, markersize=0.15, markershapes=shapes, markercolor=:white, x=xpos, y=ypos)

# ╔═╡ faf43628-2417-4f58-8f0a-87024010ee8f
md"""
Replace the contents of this cell with your caption. 
"""

# ╔═╡ 6d9c58be-8abf-4e13-866c-d883c97d3614
md"""
## Part 2: Model Formulation

Show the process of formulating the model for your system. This is best done with equations supported by some descriptions.
"""

# ╔═╡ d599001b-0236-4815-8551-33fe0b111f70
md"""
Use this block to derive the equations of your optimization problem.
"""

# ╔═╡ 64e42bf6-a97c-4082-aeca-b1d1238d22ef
md"""
...
# ╔═╡ 15ad3ddb-9dbb-41e4-a888-6c1cf3fdaeb7
# import any necessary packages here

# ╔═╡ f6720dce-2c89-410e-b41a-a6053d4c5f69
...
# ╔═╡ 9f9568c4-de30-43f7-a0ef-8f248cdce209
md"""
...
# ╔═╡ 003585fa-1991-4a5b-af7b-890d096f0e8c
md"""
Describe your results here.
"""

# ╔═╡ a8bb65bd-5e6d-4c04-9b93-76693a72acc2
md"""
#### Part 4.2: Further Considerations

What do you think should be investigated further to improve your model? What assumptions did you make that should be kept in mind when interpreting your results?
"""

# ╔═╡ 1f109c7c-1e53-42f0-a214-ebecded1630b
md"""
Describe any further considerations here. 
"""

# ╔═╡ 90970e7a-689b-4304-907b-70d1fa274387
md"""
## Citations
...
# ╔═╡ 9024d4cf-fd42-4048-b2dd-67bc1ce81805
md"""
...
git-tree-sha1 = "82a923cd1497adc7dfd07c1dad5e8eb79e5c4499"
