...
#calculate each factor of the equation (see notes)
factor1 = (1/(pi*sigy*sigz*U));
factor2 = exp(-0.5*((y/sigy)^2 + (H/sigz)^2));

#calculate transport coefficient
t_xy = factor1*factor2;
...
t_12 = calculateTxy(1.5,50,3000,0)

# ╔═╡ 4d3f9c80-f074-4b8a-a2af-4ce8aef2ee5a
t_22 = calculateTxy(1.5,200,1000,2000)
